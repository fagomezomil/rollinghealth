...
export default function SlideCentros() {
    return (
        <div className="p-12 relative">
            <p className="text-[50px] text-[#126459] font-bold">Conocé nuestros Centros Médicos</p>
            <p className="text-neutral-500 italic text-2xl lg:w-[70%] mb-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae doloribus iste dolorum inventore ullam? Similique voluptatum tenetur suscipit facilis, ad quam deleniti!</p>
